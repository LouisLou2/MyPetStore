...
<div id="BackLink">
    <a href="${pageContext.request.contextPath}/shop/view/product?productId=${sessionScope.product.productId}">Return to ${sessionScope.product.productId}</a>
</div>
...
<table>
	<td>
		<image src="${pageContext.request.contextPath}/${requestScope.picture}"/>
	</td>
	<tr>
