...
public class ConfirmOrderFormServlet extends HttpServlet {
    ...
    private static final String ERROR="/WEB-INF/jsp/order/hasSubmitted.jsp";

    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        Object theOrder=request.getSession().getAttribute("order");
        if(theOrder==null){
            request.setAttribute("error", ErrorEnum.ShopError.ORDER_NOTEXIST.getMessage());
